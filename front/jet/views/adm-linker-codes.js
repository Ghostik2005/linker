    ...
    config(){
        ...
        var top = {//view: 'layout',
            ...
            cols: [
                ...
                {view:"button", type: 'htmlbutton', localId: "apply", hidden: !app.config.roles[app.config.role].useradd,
                ...
                {view:"button", type: 'htmlbutton', localId: "cancel", hidden: !app.config.roles[app.config.role].useradd,
