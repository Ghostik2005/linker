...
export default class SubRow extends JetView {
                                                    ...
                                                    on: {
                                                        ...
                                                        onAfterRender: function () {
                                                            ...
                                                            if (['antey1', 'antey2'].includes(this.$scope.app.config.user) && !this.$scope.customData.item.id_group) {
                                                                ...
                                                                //     this.getList().parse([{ id: 'BP', group: "Бытовая химия/бытовые приборы/хозтовары" },]);
                                                                //     this.getList().parse([{ id: 'TE', group: "Текстиль" },]);
                                                                //     this.getList().parse([{ id: '2', group: "Бады" },]);
                                                                //     this.getList().parse([{ id: 'ZakMedCtg.39', group: "БАД" },]);
                                                            } else {
                                                                this.getList().parse(group);
                                                            }
    ...
    ready(view) {
        ...
        // }
        if (
            (permited_add.users.includes(this.app.config.user) && !['ZakMedCtg.1114', 'ZakMedCtg.39'].includes(item.id_group)) ||
            ...
            !['ZakMedCtg.1114', 'ZakMedCtg.39'].includes(item.id_group)

            // (permited_add.users.includes(this.app.config.user) && ['BP', 'TE', '2', 'ZakMedCtg.39', 'ZakMedCtg.18', 'OR', 'Z', 'ZakMedCtg.17'].includes(item.id_group)) || 
            // (['antey1', 'antey2'].includes(this.app.config.user) && !this.customData.item.id_group) || 
            // this.app.config.roles[this.app.config.role].spredit || 
            // ['BP', 'TE', '2', 'ZakMedCtg.39', 'ZakMedCtg.18', 'ZakMedCtg.1115', 'OR', 'Z', 'ZakMedCtg.17'].includes(item.id_group)
        ) {
