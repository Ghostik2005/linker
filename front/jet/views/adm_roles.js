    ...
    config() {
        ...
        var sprv = {
            ...
            columns: [
                ...
                {
                    id: "user", fillspace: 1, css: "center_p", template: "{common.checkbox()}",
                    header: [{ text: "Имя роли", colspan: 5, css: "center_p" },
                    { text: $$("roles_dc").getItem(1).r_name }
                    ],
                },
                {
                    id: "linker", fillspace: 1, css: "center_p", template: "{common.checkbox()}",
                    header: [{},
                    { text: $$("roles_dc").getItem(9).r_name },
                    ],
                },
                {
                    id: "admin", css: "center_p", template: "{common.checkbox()}",
                    fillspace: 1,
                    header: [{},
                ...
                {
                    id: "superadmin", css: "center_p", template: "{common.checkbox()}",
                    fillspace: 1,
                    header: [{},
                ...
                {
                    id: "qqq", css: "center_p", template: "{common.checkbox()}",
                    fillspace: 1,
                    header: [{},
            ...
            cols: [
                ...
                },
                {
                    ...
                    click: () => {
                        ...
                        let res = checkVal(request(url, params, !0).response, 's', this.app);
                        if (res) {
                            let params = {};
