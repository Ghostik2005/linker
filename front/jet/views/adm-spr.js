    ...
    config() {
        ...
        var sprv = {
            ...
            columns: [
                ...
                {
                    id: "id_jv_fp", width: 100,
                    tooltip: false,
                    template: function (obj) {
                        return (+obj.id_jv_fp !== 0) ? "<span class='webix_icon fa-check-circle', style='color: green'></span>"
                            : "";
                    },
                    css: "center_p",
                    header: [{ text: "ЖВ ФП", css: "center_p" },
                    {
                        content: "richFilt", compare: compareTrue,
                        inputConfig: {
                            options: [{ id: 1, value: "Да" }, { id: 2, value: "Нет" }],
                ...
                {
                    id: "c_issue", width: 100,
                    tooltip: "#c_issue#",
                    hidden: true,
                    header: [{ text: "ФВ", css: "center_p" },
                    {
                        content: "richFilt", compare: compareTrue,
                        inputConfig: {
                            options: [{ id: 1, value: "Да" }, { id: 2, value: "Нет" }],
                ...
                {
                    id: "prescr", width: 160, hidden: !true, css: 'center_p', tooltip: false,
                    template: function (obj) {
                        let ret_value;
                    ...
                    header: [{ text: "Рецептурный" },
                    {
                        content: "richFilt", compare: compareTrue,
                        inputConfig: {
                            options: [{ id: 1, value: "Рецепт. (148)" }, { id: 2, value: "Нет" }, { id: 3, value: "Рецепт. (107)" }],
                            scrollView: true,
                        },
                    }
                    ],
