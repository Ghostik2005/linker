...
class Worker:
    ...
    def getMail(self):
        try:
            ...
            sql = """select sh_prc, title, title_torg, seriya, fabricator, region, n_rec, dt_edit, gv, title_doc, opis, link_file, id from brak_mail where sh_prc = '%s' and seriya = '%s' """ % ( action[1], action[0] )
