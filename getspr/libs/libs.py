...
class SCGIServer:
    ...
    def _init(self, sock):
        ...
        # if (!-f /ms71/data/getspr/api-k/$http_x_api_key) {
        # return 403;
        # }
        ...
        scgi_pass                 getspr_ups;

        proxy_connect_timeout       600s;
        proxy_send_timeout          600s;
        proxy_read_timeout          600s;
        send_timeout                600s;
        scgi_send_timeout           600s;
...
def f_head(aContentLength, fName='spr.db3'):
    ...
    r.append(("Content-Disposition", f"attachment; filename={fName}"))
    return r
