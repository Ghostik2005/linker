...
__appname__ = 'merge3'
__version__ = '19.301.1450' #получаем историю еще одним способом
# __version__ = '19.186.0900' #не добавляются задачи на удаление с пустыми параметрами
# __version__ = '19.080.1230' #исправленны запросы
# __version__ = '19.066.0920' #добавлена работа с авторизацией из склада
# __version__ = '19.064.0820' #добавлена работа с авторизацией из склада
# __version__ = '19.053.1610' #добавлен метод setReferenceLinks, работает через fdbsrv
